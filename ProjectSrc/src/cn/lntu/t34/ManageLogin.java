...
public class ManageLogin extends JFrame implements ActionListener{
  ...
  //     user.setColumns(30);
        ...
        passWd.addFocusListener(new Focus1());
        ...
        setBounds(300,170,325,240);            //设置窗口显示位置
        getRootPane().setDefaultButton(b1);
        setDefaultCloseOperation(HIDE_ON_CLOSE); //关闭窗口时推车应用程序
        setVisible(true);
    ...
    class Focus1 implements FocusListener{
