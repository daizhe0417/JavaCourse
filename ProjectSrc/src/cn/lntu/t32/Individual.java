...
implements ActionListener, MouseListener {
	...
	public static JLabel lbA, lbB, lbC;			//���ͷ���,��������,Ԥ�赥��
	public static JComboBox cb2;				//��������
	public static JCheckBox chk1;				//�ӵ㷿��
	public static DefaultTableModel dtm1, dtm2;	//�ɹ�������б��DTM
    ...
    /**=======================================================================**
	 *		[## public Individual(JFrame frame) {} ]: 			���캯��
	 *			����   ��JFrame frame��ʾ���Ի���ĸ�����
	 *			����ֵ ����
	 *			���η� ��public
	 *			����   ��ɢ�Ϳ�������
	...
	private void saveLiveIn() {
		...
		if(chk2.isSelected())
			cluemark	= 1;
		String sqlCode[]= new String[tb2.getRowCount() * 2];	//Ҫ������Ҫ��״̬��������������С��SQL����
		try {
			int rcss = 0;					//����¼ָ��
