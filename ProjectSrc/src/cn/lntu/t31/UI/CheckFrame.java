...
public class CheckFrame extends JFrame implements MainFrame,Runnable {
	...
	private  DefaultMutableTreeNode  root11=new DefaultMutableTreeNode(new  MyNode("个人项目信息�?�?",11));
	private  DefaultMutableTreeNode  root12=new DefaultMutableTreeNode(new  MyNode("科研人员项目信息�?�?",12));
	...
	private  DefaultMutableTreeNode  root33=new DefaultMutableTreeNode(new  MyNode("�?出系�?",33));
