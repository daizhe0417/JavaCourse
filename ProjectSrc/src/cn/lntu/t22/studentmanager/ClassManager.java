...
public class ClassManager  extends JFrame {
	XYLayout xYLayout1 = new XYLayout();
	 ...
	 Object[][] arrData = {};
	 String[] arrField = {"班级编号", "系部名称", "专业名称", "班级名称"};
	...
	ClassManager_jComboBox2_actionAdapter(this));
	 jTextField1.setFont(new java.awt.Font("Dialog", Font.PLAIN, 16));
	 jRadioButton1.setFont(new java.awt.Font("Dialog", Font.PLAIN,
	16));
	 jRadioButton1.setText("按系部查询：");
	 jRadioButton1.addItemListener(new
	 ClassManager_jRadioButton1_itemAdapter(this));
	 jRadioButton1.addActionListener(new

	ClassManager_jRadioButton1_actionAdapter(this));
	...
	ClassManager_jButton6_actionAdapter(this));
	 ...
	 new XYConstraints(10, 239, 510,225));
	 ...
	 jComboBox2.addItem(xibu);
		 ...
		 public void jRadioButton2_itemStateChanged(ItemEvent e) {
			 ...
			 sql = "select * from deptS where DeptName='" +
			 String.valueOf(jComboBox1.getSelectedItem()) + "'";
			 UpdateRecord();
			 }
			 public void jButton2_actionPerformed(ActionEvent e) {
			 sql = "select * from deptS where SpecialityName='" +
			 String.valueOf(jComboBox3.getSelectedItem()) + "'";
			 UpdateRecord();
			 }
			 public void jButton3_actionPerformed(ActionEvent e) {
			 sql = "select * from deptS where ClassName='" +
			jTextField1.getText() +
			 "'";
			 UpdateRecord();
			 }
			 public void jButton4_actionPerformed(ActionEvent e) {
				...
				this.dispose();
				 ...
				 try {
				 conn.getUpdate("delete from Class where ClassName='" + find
				+ "'");
				 jOptionPane1.showMessageDialog(this, "删除成功！", "提示",
				...
				String.valueOf(jComboBox2.getSelectedItem()) +
				 ...
				 try {
					 ...
					 vec.add(rs3.getString("DeptName").trim());
					 vec.add(rs3.getString("SpecialityName"));
