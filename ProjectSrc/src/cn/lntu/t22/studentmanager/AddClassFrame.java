...
public class AddClassFrame  extends JFrame {
	...
	AddClassFrame_jButton1_actionAdapter(this));
	...
	AddClassFrame_jButton2_actionAdapter(this));
	...
	AddClassFrame_jComboBox1_actionAdapter(this));
	 ...
	 try {ResultSet rs = conn.getRs("select * from ds where DeptName='"
			 +
			 ...
			 sel +
			  ...
			  public void jButton2_actionPerformed(ActionEvent e) {
				  ...
				  jOptionPane1.showMessageDialog(this, "请选择所属系部！", " 提示",JOptionPane.INFORMATION_MESSAGE, null);
				  } else
				  ...
				  while (rs.next()) {
				  if (jTextField1.getText().trim().equals(rs.getString(
				  "ClassName").trim())) {
				  classname = true;
				  }
				  }
				  if (classname) {
					  jOptionPane1.showMessageDialog(this, "该班级名称已 经存在！", "提示", JOptionPane.INFORMATION_MESSAGE, null);
					  } else {
					  conn.getUpdate( "insert into Class (ClassName,SpecialityId) values ('" +
					  jTextField1.getText().trim() + "','" + xi + "')");
					  jOptionPane1.showMessageDialog(this, "恭喜您班级信息注册成功！", "提示",JOptionPane.INFORMATION_MESSAGE, null);
					  }
					  } catch (Exception ce) {
					  System.out.println(ce);
					  }
					 ...
					 class AddClassFrame_jComboBox1_actionAdapter implements ActionListener
					 {
					  ...
					  AddClassFrame_jComboBox1_actionAdapter(AddClassFrame adaptee) {this.adaptee = adaptee;
					  }
					 ...
					 class AddClassFrame_jButton1_actionAdapter implements ActionListener {
					  private AddClassFrame adaptee;
					  AddClassFrame_jButton1_actionAdapter(AddClassFrame adaptee) {
					 ...
					 class AddClassFrame_jButton2_actionAdapter implements ActionListener {
					  private AddClassFrame adaptee;
					  AddClassFrame_jButton2_actionAdapter(AddClassFrame adaptee) {
					  this.adaptee = adaptee;
					  }
					  public void actionPerformed(ActionEvent e) {
